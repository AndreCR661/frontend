<template>
  <v-app>
    ...
    <v-container>
      ...
      <v-btn color="primary" class="mb-4" @click="openAddUserDialog">
        ...
        <v-card>
          ...
          <v-card-text>
            <v-form ref="userForm" v-model="valid">
              ...
              <v-text-field v-model="form.email" label="Correo Electrónico" required type="email"></v-text-field>
              <v-text-field v-model="form.password" label="Contraseña" required :type="showPassword ? 'text' : 'password'">
                <template #append>
